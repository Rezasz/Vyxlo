  ...
  return (
    <>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4 text-charcoal">Transforming Industries</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {cases.map((case_) => (
              <div key={case_.id} className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-2xl font-bold mb-4 text-charcoal">{case_.title}</h3>
                <p className="text-charcoal-muted mb-6 text-lg">{case_.description}</p>
      ...
      <section className="bg-gray-50 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4 text-charcoal">Success Stories</h2>
            <p className="text-xl text-charcoal-muted max-w-3xl mx-auto">
